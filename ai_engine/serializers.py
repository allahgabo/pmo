...
class RiskSerializer(serializers.ModelSerializer):
    risk_score = serializers.SerializerMethodField(help_text="Calculated risk score (probability * impact)")
...
class TaskSerializer(serializers.ModelSerializer):
    is_overdue = serializers.SerializerMethodField(help_text="Whether the task is overdue")
    days_until_due = serializers.SerializerMethodField(help_text="Number of days until due date")
